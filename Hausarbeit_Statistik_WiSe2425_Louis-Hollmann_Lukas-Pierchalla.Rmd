...
# Im Zeitverlauf werden die Mondphasen hervorgehoben
plot(durchschnittspreise$Group.1, durchschnittspreise$e5_median, type = "l", col = "blue", xlab = "Datum", ylab = "Preis in 1/10 Cent", main = "Preisverlauf von E5, E10 & Diesel", ylim = c(1500, 2000))
lines(durchschnittspreise$Group.1, durchschnittspreise$e10_median, col = "red")
lines(durchschnittspreise$Group.1, durchschnittspreise$diesel_median, col = "green")
for (i in seq_len(nrow(mondphasen))) {
  abline(v = mondphasen$date[i], col = "grey", lty = 2)
}
legend("bottomright", legend = c("E5", "E10", "Diesel"), col = c("blue", "red", "green"), lty = 1, cex = 0.8)
legend("topright", legend = "Mondphasen", col = "grey", lty = 2, cex = 0.8)



```

Für eine zweite überprüfung der Hypothese wird der Preisverlauf von E5, E10 und Diesel über den Zeitraum von 2023 dargestellt. Die Mondphasen sind im Diagramm als graue Linien hervorgehoben. Es ist zu erkennen, dass die Preise für E5, E10 und Diesel unabhängig von den Mondphasen schwanken. Dies bestätigt die vorherige Analyse, dass die Kraftstoffpreise in Berlin nicht von den Mondphasen beeinflusst werden.
