...
legend("bottomleft", legend = c("E5", "E10", "Diesel"), col = c("blue", "red", "green"), lty = 1, bty = "n")
legend("topright", legend = "Schulferien", fill = "lightgrey", density = 25, bty = "n")
legend("bottomright", legend = c("E5 - mean", "E10 - mean", "Diesel - mean"), col = c("blue", "red", "green"), lty = 2, bty = "n")
...
Es wurden bereits Unterschiede zwischen den Kraftstoffpreisen festgestellt. Nun sollen mögliche Einflussfaktoren auf die Preisentwicklung untersucht werden. Dazu werden vier Hypothesen aufgestellt und überprüft.
...
par(mfrow = c(1, 3))
barplot(varianz_e5, main = "Varianz der Kraftstoffpreise \n an verschiedenen Wochentagen (E5)", ylab = "Varianz", col = ifelse(names(varianz_e5) == "Fr", "orange", "lightblue"), ylim = c(0, 11000))
abline(h = mean(varianz_e5), col = "red", lwd = 2)
legend("topright", legend = c("Durchschnittliche Varianz"), col = "red", lty = 1, bty = "n", cex = 1.5)
barplot(varianz_e10, main = "(E10)", ylab = "Varianz", col = ifelse(names(varianz_e10) == "Fr", "orange", "lightblue"), ylim = c(0, 11000))
abline(h = mean(varianz_e10), col = "red", lwd = 2)
legend("topright", legend = c("Durchschnittliche Varianz"), col = "red", lty = 1, bty = "n", cex = 1.5)
barplot(varianz_diesel, main = "(Diesel)", ylab = "Varianz", col = ifelse(names(varianz_diesel) == "Fr", "orange", "lightblue"), ylim = c(0, 11000))
