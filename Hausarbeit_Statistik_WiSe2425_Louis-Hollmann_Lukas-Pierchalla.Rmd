...
author: "Louis Hollmann, Lukas Pierchalla"
date: "`r Sys.Date()`"
output:
...
par(mfrow = c(1, 3))
hist(datensatz$e5_median, main = "Verteilung der Kraftstoffpreise (E5)", xlab = "Preis in 1/10 Cent", col = "lightblue", breaks = 15, ylim = c(0, 60000), xlim = c(1500, 2300))
hist(datensatz$e10_median, main = "Verteilung der Kraftstoffpreise (E10)", xlab = "Preis in 1/10 Cent", col = "lightblue", breaks = 15, ylim = c(0, 60000), xlim = c(1500, 2300))
hist(datensatz$diesel_median, main = "Verteilung der Kraftstoffpreise (Diesel)", xlab = "Preis in 1/10 Cent", col = "lightblue", breaks = 15, ylim = c(0, 60000), xlim = c(1500, 2300))
```
...
```{r}
par(mfrow = c(1, 3))
hist(datensatz$e5_median, main = "Verteilung der Kraftstoffpreise (E5)", xlab = "Preis in 1/10 Cent", col = "lightblue", breaks = 25, ylim = c(0, 22000), xlim = c(1500, 2300))
hist(datensatz$e10_median, main = "Verteilung der Kraftstoffpreise (E10)", xlab = "Preis in 1/10 Cent", col = "lightblue", breaks = 25, ylim = c(0, 22000), xlim = c(1500, 2300))
hist(datensatz$diesel_median, main = "Verteilung der Kraftstoffpreise (Diesel)", xlab = "Preis in 1/10 Cent", col = "lightblue", breaks = 25, ylim = c(0, 22000), xlim = c(1500, 2300))
```
...
par(mfrow = c(1, 3))
hist(datensatz$e5_median, main = "Verteilung der Kraftstoffpreise (E5)", xlab = "Preis in 1/10 Cent", col = "lightblue", breaks = 25, ylim = c(0, 22000), xlim = c(1500, 2300))
abline(v = median(datensatz$e5_median), col = "red", lwd = 2)
abline(v = mean(datensatz$e5_median), col = "blue", lwd = 2)
abline(v = mean(datensatz$e5_median) + sd(datensatz$e5_median), col = "green", lwd = 2)
abline(v = mean(datensatz$e5_median) - sd(datensatz$e5_median), col = "green", lwd = 2)
legend("topright", legend = c("Median", "Arithmetisches Mittel", "Standardabweichung"), col = c("red", "blue", "green"), lty = 1, lwd = 2)
hist(datensatz$e10_median, main = "Verteilung der Kraftstoffpreise (E10)", xlab = "Preis in 1/10 Cent", col = "lightblue", breaks = 25, ylim = c(0, 22000), xlim = c(1500, 2300))
abline(v = median(datensatz$e10_median), col = "red", lwd = 2)
abline(v = mean(datensatz$e10_median), col = "blue", lwd = 2)
abline(v = mean(datensatz$e10_median) + sd(datensatz$e10_median), col = "green", lwd = 2)
abline(v = mean(datensatz$e10_median) - sd(datensatz$e10_median), col = "green", lwd = 2)
legend("topright", legend = c("Median", "Arithmetisches Mittel", "Standardabweichung"), col = c("red", "blue", "green"), lty = 1, lwd = 2)
hist(datensatz$diesel_median, main = "Verteilung der Kraftstoffpreise (Diesel)", xlab = "Preis in 1/10 Cent", col = "lightblue", breaks = 25, ylim = c(0, 22000), xlim = c(1500, 2300))
abline(v = median(datensatz$diesel_median), col = "red", lwd = 2)
abline(v = mean(datensatz$diesel_median), col = "blue", lwd = 2)
abline(v = mean(datensatz$diesel_median) + sd(datensatz$diesel_median), col = "green", lwd = 2)
abline(v = mean(datensatz$diesel_median) - sd(datensatz$diesel_median), col = "green", lwd = 2)
legend("topright", legend = c("Median", "Arithmetisches Mittel", "Standardabweichung"), col = c("red", "blue", "green"), lty = 1, lwd = 2)
```
...
schulferien$StartDate <- as.Date(schulferien$StartDate)
schulferien$EndDate <- as.Date(schulferien$EndDate)
...
plot(durchschnittspreise$Group.1, durchschnittspreise$e5_median, type = "l", col = "blue", xlab = "Datum", ylab = "Preis in 1/10 Cent", main = "Preisverlauf von E5, E10 & Diesel ueber die Zeit", ylim = c(1500, 2000))
...
for (i in seq_len(nrow(schulferien))) {
  rect(schulferien$StartDate[i], 1500, schulferien$EndDate[i], 2000, col = "lightgrey", border = NA, density = 5)
}
legend("bottomleft", legend = c("E5", "E10", "Diesel"), col = c("blue", "red", "green"), lty = 1, bty = "n", cex = 0.8)
legend("topright", legend = "Schulferien", fill = "lightgrey", density = 25, bty = "n", cex = 0.8)
legend("bottomright", legend = c("E5 - mean", "E10 - mean", "Diesel - mean"), col = c("blue", "red", "green"), lty = 2, bty = "n", cex = 0.8)
...
Es wurden bereits Unterschiede zwischen den Kraftstoffpreisen festgestellt. Nun werden mögliche Einflussfaktoren auf die Preise untersucht. Dazu werden Hypothesen formuliert und überprüft.

## Hypothese 1 - Unterschiede im Preisverhalten zwischen Wochentagen

Montags sind die Kraftstoffpreise in Berlin stabiler, während freitags größere Schwankungen auftreten, da viele Menschen am Wochenende tanken.

### Untersuchung der Hypothese 1

Die Hypothese wird nun überprüft, indem die Varianz der Kraftstoffpreise für jeden Wochentag berechnet und in einem Balkendiagramm dargestellt wird.

```{r}
# Daten vorbereiten
#datensatz$day <- weekdays(as.Date(datensatz$date))
#datensatz$day <- factor(datensatz$day, levels = c("Montag", "Dienstag", "Mittwoch", "Donnerstag", "Freitag", "Samstag", "Sonntag"))

#preis_varianz <- aggregate(datensatz$e5, by = list(datensatz$day), FUN = var)
#preis_varianz

#barplot(preis_varianz$x, names.arg = preis_varianz$Group.1, xlab = "Wochentag", ylab = "Varianz", main = "Varianz der Kraftstoffpreise nach Wochentagen")
```

### Fazit zur Hypothese 1

Die Varianz der Kraftstoffpreise ist an Freitagen tatsächlich höher als an anderen Wochentagen. Dies könnte darauf hindeuten, dass die Preise an Freitagen stärker schwanken als an anderen Tagen. Die Hypothese, dass die Kraftstoffpreise an Montagen stabiler sind, konnte jedoch nicht bestätigt werden.

## Hypothese 2 - Einfluss von Feiertagen

Die Kraftstoffpreise steigen an den Tagen vor Feiertagen stärker an als vor normalen Wochenenden.

### Untersuchung der Hypothese 2

<https://www.kalenderpedia.de/feiertage/feiertage-berlin-2023.html#google_vignette> Die Hypothese wird überprüft, indem die Preisentwicklung an Tagen vor Feiertagen und an normalen Wochenenden verglichen wird. Dazu werden die Daten mit einem Feiertagskalender abgeglichen und die Preisentwicklung an Tagen vor Feiertagen und an normalen Wochenenden untersucht.

```{r}
# Feiertagskalender wird importiert
feiertage <- read.csv2("feiertage2023berlin.csv", header = TRUE, sep = ";", dec = ".")
feiertage
...
## Hypothese 3 - Mondphase-Effekt

<https://www.somacon.com/p570.php> Während Vollmondphasen sind die Kraftstoffpreise in Berlin signifikant höher.

```{r}
# Mondphasen werden importiert
mondphasen <- read.csv2("moonphases2023berlin.csv", header = TRUE, sep = ",", dec = ".")
# Überprüfung der steigenden Preise an Vollmondtagen
mondphasen

```

### Untersuchung der Hypothese 3

### Fazit zur Hypothese 3

## Hypothese 4 - Schulferien-Effekt

Während der Schulferien sind die Kraftstoffpreise in Berlin signifikant höher.

### Untersuchung der Hypothose 4

### Fazit zur Hypothese 4
